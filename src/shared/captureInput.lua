-- ReplicatedStorage/Shared/captureInput.lua
...
local function setupControlGui(player)
    -- Create a ScreenGui and buttons for WASD controls
...
local function handleInput(player, buttons)
    ...
    UserInputService.InputBegan:Connect(function(input, gameProcessed)
        ...
        if input.UserInputType == Enum.UserInputType.Keyboard then
            ...
            if key == "Space" and allKeysPressed() then
                print("All keys pressed and Space input detected: " .. key)
